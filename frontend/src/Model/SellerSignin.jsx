...
import { useNavigate } from 'react-router-dom'
 ...
 const SellerSignin = ({authType}) => {
  ...
  return (
    ...
    <button className='w-[100%] bg-secondary hover:bg-priamry transition-all ease-linear duration-300 h-10 rounded-md' onClick={handleSubmit}><b className="shadow-lg px-1 pb-[2px] hover:shadow-current hover:border-[#03045e] hover:border-2 rounded-[30%]">Sign in</b></button>
    <p className='text-gray-500 pl-2'>Don't have a account? <a className='underline cursor-pointer hover:text-[#03045e]' onClick={()=>{authType("signup")}}>Signup</a></p>
</div>
</div>
<Toaster />
</div>
